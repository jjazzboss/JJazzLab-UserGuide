...
* Configuration de l'[output synth](../sounds/other-synths.md)
* Paramètres de la [mix console](../editors/mix-console.md) tels que l'instrument de la piste, le volume, l'état de sourdine, etc.
* Paramètres de [precount, click et tempo](../playback-control/commands.md)
* Les paramètres de [transposition des chord symbols à la lecture](../tools/chord-symbols-transposition.md)

## Exporter en Midi

Vous pouvez exporter un song entier en Midi via le menu **File/Export to Midi file...**

Vous pouvez également exporter des pistes individuelles en [faisant glisser avec la souris depuis la Mix Console](../editors/mix-console.md#export-to-midi-file-with-mouse-drag-and-drop).
...
{% hint style="danger" %}
L'export audio n'est disponible que si vous utilisez l'[output synth FluidSynth](../sounds/using-fluidsynth.md) interne.
{% endhint %}
