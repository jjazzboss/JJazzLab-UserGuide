...
<table data-header-hidden><thead><tr><th width="253.33333333333331" >選択</th><th>マウス</th><th>操作</th></tr></thead><tbody><tr><td>ノート</td><td>Ctrl+クリック</td><td>複数のノートを選択</td></tr><tr><td>エディタ</td><td>ドラッグ</td><td>複数のノートを選択</td></tr><tr><td>ノート</td><td>ドラッグ/リサイズ</td><td>Ctrl+ドラッグ</td><td>ノートの複製</td></tr><tr><td>ノート</td><td>ドラッグ/リサイズ</td><td>Ctrl+ドラッグ</td><td>ノートの複製</td></tr><tr><td>ノート</td><td>ドラッグ/リサイズ</td><td>Ctrl+ドラッグ</td><td>ノートの複製</td></tr><tr><td>ノート</td><td>ドラッグ/リサイズ</td><td>Ctrl+ドラッグ</td><td>ノートの複製</td></tr><tr><td>ノート</td><td>ドラッグ/リサイズ</td><td>Ctrl+ドラッグ</td><td>ノートの複製</td></tr><tr><td>ノート</td><td>ドラッグ/リサイズ</td><td>Ctrl+ドラッグ</td><td>ノートの複製</ td><td>移動/サイズ変更</td></tr><tr><td>音符</td><td>ctrl-ドラッグ</td><td>音符の複製</td></tr><tr><td>音符</td><td>alt-ドラッグ</td><td>グリッドスナップ設定を反転した状態での移動/サイズ変更</td></tr><tr><td>音符</td><td>alt -ホイール</td><td>ベロシティ変更</td></tr><tr><td>エディター</td><td>ホイール</td><td>エディター上下移動</td></tr><tr><td>エディター</td><td>Shift+マウスホイール</td><td>エディター左右移動</td></tr><tr><td>エディター</td><td>Ctrl+マウスホイール</td><td>水平方向ズームイン/アウト</td></tr><tr><td>エディター</td><td>Ctrl+マウスホイール</td><td>垂直方向ズームイン/アウト</td></tr><tr><td>エディター</td><td>Ctrl+マウスホイール</td><td>水平方向ズームイン/アウト</td></tr><tr><td>エディター</td><td>Ctrl+マウスホイール</td><td>垂直方向ズームイン/アウト</td></tr><tr><td>エディター</td><td>Ctrl+マウスホイール</td><td>水平方向ズームイン/アウト</td></tr><tr><td>エディター</td><td>Ctrl+マウスホイール</td><td>垂直方向ズームイン/アウト</td></tr><tr><td>エディター</td><td>Ctrl+マウスホイール</td>< tr><tr><td>エディタ</td><td>Ctrl+Shift マウスホイール</td><td>縦方向にズームイン/アウト</td></tr><tr><td>エディタ</td><td>Ctrl+ドラッグ</td><td>エディタを移動</td></tr><tr><td>ルーラー</td><td>ドラッグ</ td><td>再生ループゾーンを設定</td></tr><tr><td>ルーラー</td><td>Shiftキーを押しながらクリック</td><td>再生ループゾーンを拡張</td></tr><tr><td>ルーラー</td><td>クリック</td><td>再生ループゾーンを削除</td></tr></tbody></table>

## キーボードショートカット

| Selection | Key              | Action                                                   |
| --------- | ---------------- | -------------------------------------------------------- |
| 音符      | alt-up/down      | change velocity                                          |
| 音符      | ctrl-C/X/V       | copy/cut/paste notes                                     |
| 音符      | delete           | delete notes                                             |
| 音符      | ctrl-shift-I     | invert notes selection                                   |
| 音符      | ctrl-H           | open humanize dialog                                     |
| 音符      | Q                | quantize selected notes (or all no selection)            |
| エディター| ctrl-F           | zoom to fit notes                                        |
| エディター| G                | snap-to-grid                                             |
| エディター| A                | auto-scroll during playback                              |
| エディター| S                | solo the edited phrase                                   |
| エディター| H                | hear the selected notes                                  |
| エディター| Home/End         | Move editor to start/end                                 |
| エディター| ctrl-shift-スペース | play the loop zone (if set) or whole phrase              |
| エディター| ctrl-スペース       | play from loop zone (if set) or from first selected note |
