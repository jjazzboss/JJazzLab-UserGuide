...
Lorsque vous insérez une nouvelle [section](../editors/chord-lead-sheet.md#sections) avec une nouvelle signature temporelle, JJazzLab doit sélectionner un rhythm pour la nouvelle [song part](../editors/song-structure.md#song-parts).
...
Utilisez la [boîte de dialogue de sélection du rhythm](../editors/song-structure.md#change-rhythm) pour remplacer un rythme adapté par un rhythm standard (ou vice-versa).
