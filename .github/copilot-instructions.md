...
- `workflow_dispatch` on `.github/workflows/manual-translation-sync.yml` is the manual translation workflow. It expects a `from_ref` input and uses Copilot CLI to open one PR per language branch.
